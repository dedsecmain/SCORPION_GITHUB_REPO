...
MODEL_CATALOG = {
    ...
    "qwen3:4b": {"tier": "low", "vision": False},
    "qwen3.5:4b": {"tier": "low", "vision": True},
    "qwen3:8b": {"tier": "balanced", "vision": False},
    "qwen3.5:9b": {"tier": "balanced", "vision": True},
...
class ModelManager:
    ...
    def role_candidates(self, role: str, profile) -> tuple[str, ...]:
        ...
        if normalized_role == "vision":
            if capability == "performance":
                candidates = ("gemma3:12b", "qwen3.5:9b", "gemma3:4b", "qwen3.5:4b")
            elif capability == "balanced":
                candidates = ("gemma3:4b", "qwen3.5:4b", "gemma3:12b", "qwen3.5:9b")
            else:
                candidates = ("gemma3:4b", "qwen3.5:4b")
    ...
    def recommend(self, profile, installed_models: set[str] | None = None) -> ModelRecommendation:
        ...
        return ModelRecommendation(
            text,
            vision,
            f"Hardware-Profil: {capability} · Qwen-first für Text · Vision lokal",
        )
